      ...
      <Container>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm">
            ...
            <div className="text-4xl font-bold text-[#0f172a]">{stats.total}</div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-200">
            ...
            <div className="text-4xl font-bold text-emerald-700">{stats.up}</div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-red-50 border border-red-200">
            ...
            <div className="text-4xl font-bold text-red-700">{stats.down}</div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-[#e2e8f0] shadow-sm">
            ...
            <div className="text-4xl font-bold text-[#0f172a]">±{stats.avgChange}%</div>
          </div>
        </div>
